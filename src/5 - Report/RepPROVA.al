report 50501 "F1 - Prod. Order - List"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/5 - Report/layouts/ProdOrderList.rdl';
    ...
    dataset
    {
        dataitem("Production Order"; "Production Order")
        {
            ...
            column(Production_Order__Starting_Date_Time; Format("Starting Date-Time"))
            {
            }
    ...
    var
        ...
        Production_Order__Starting_Date_CaptionLbl: Label 'Starting Date and Time';
